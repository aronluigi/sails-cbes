...
module.exports = (function () {
  ...
  var adapter = {
    ...
    create: function(connectionName, collectionName, data, cb) {
      var connectionObject = a[connectionName];
    ...
    join: function (connectionName, collectionName, criteria, cb) {
      ...
      _runJoins({
        ...
        $find: function (collectionIdentity, criteria, cb) {
          var connectionObject = connections[connectionName];
          connectionObject.database.find(collectionIdentity, criteria, cb);
        },
        ...
        $getPK: function (collectionIdentity) {
          ...
          return connectionObject.database.schema._primary[collectionIdentity];
        }
      }, cb);
