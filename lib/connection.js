...
Connection.prototype._buildConnection = function _buildConnection(collections, cb) {
    ...
    Object.keys(collections).forEach(function(key){
        ...
        if (typeof collections[key].mapping == 'object') {
            ...
            if ('ttl' in collections[key].attributes &&
                collections[key].attributes.ttl.hasOwnProperty('defaultsTo') &&
                collections[key].attributes.ttl.defaultsTo == 'number')
            {
                _tmp.body._ttl = {
                    "enabled": true,
                    "default": collections[key].attributes.ttl.defaultsTo
                };
            }
